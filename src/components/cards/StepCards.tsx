...
const steps = [
  {
    ...
    icon: <UserPlus className="w-4 h-4 text-rose-700" />,
  },
  {
    number: 2,
    ...
    icon: <LayoutTemplate className="w-4 h-4 text-rose-700" />,
  },
  {
    number: 3,
    title: "Customization",
    ...
    icon: <Edit3 className="w-4 h-4 text-rose-700" />,
  },
  {
    number: 4,
    ...
    icon: <Download className="w-4 h-4 text-rose-700" />,
  },
];
