...
const Header = () => {
  ...
  return (
    <header className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 inset-s-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-7xl flex flex-wrap items-center mx-auto space-x-6 p-4">
        <Logo />
